...
def start():
    ...
    start_path = "C:\\Users\\user\\Desktop\\Work Files"
    start_path2 = "C:\\Users\\user\\Desktop\\Work Files2"
...
def debug():
    ...
    start_path = "C:\\Users\\user\\Desktop\\Excel Search\\debug"
    start_path2 = "C:\\Users\\user\\Desktop\\Excel Search\\debug2"
    save_to_txt("System SN", "RF SN")
    file_list = search_files(start_path) + search_files(start_path2)
    for search in a:
        for file in file_list:
